...
function AppProvider({ children }) {
    ...
    const [transactionsLoading, setTransactionsLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    // ========== CLIENTS CRUD (Supabase) ==========
    const fetchClients = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('clients').select('*').order('created_at', {
                ascending: false
            });
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao carregar clientes');
        } finally{
            setLoading(false);
        }
    };
    ...
    const addClient = async (clientData)=>{
        try {
            // Validate input
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateClient"])(clientData);
            if (!validation.isValid) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatErrors"])(validation.errors));
                return;
            }
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('clients').insert([
                {
            ...
            if (data && clientData.access_creds) {
                const credPromises = Object.entries(clientData.access_creds).map(([platform, cred])=>{
                    if (cred && cred.u) {
                        return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('client_credentials').insert([
                            {
                                client_id: data.id,
                                platform,
                                username: cred.u,
            ...
            await fetchClients();
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Cliente adicionado com sucesso!');
        } catch (error) {
            console.error('Error adding client:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao adicionar cliente');
        }
    };
    const updateClientStage = async (id, stage)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('clients').update({
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Stage atualizado!');
        } catch (error) {
            console.error('Error updating client stage:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao atualizar stage');
        }
    };
    const deleteClient = async (id)=>{
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('clients').delete().eq('id', id);
            if (error) throw error;
            setClients((prev)=>prev.filter((c)=>c.id !== id));
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Cliente deletado com sucesso!');
        } catch (error) {
            console.error('Error deleting client:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao deletar cliente');
        }
    };
    const updateClient = async (id, data)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('clients').update(data).eq('id', id);
            if (error) throw error;
            setClients((prev)=>prev.map((c)=>c.id === id ? {
                        ...c,
                        ...data
                    } : c));
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Cliente atualizado!');
        } catch (error) {
            console.error('Error updating client:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao atualizar cliente');
        }
    };
    // ========== TASKS CRUD (Supabase - MIGRADO!) ==========
    const fetchTasks = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tasks').select(`
                    *,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao carregar tasks');
        } finally{
    ...
    const addTask = async (taskData)=>{
        try {
            // Validate input
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateTask"])(taskData);
            if (!validation.isValid) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatErrors"])(validation.errors));
                return;
            }
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tasks').insert([
                {
            ...
            if (error) throw error;
            await fetchTasks();
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Task criada com sucesso!');
        } catch (error) {
            console.error('Error adding task:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao criar task');
        }
    };
    const updateTask = async (id, taskData)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tasks').update(taskData).eq('id', id);
            if (error) throw error;
            await fetchTasks();
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Task atualizada!');
        } catch (error) {
            console.error('Error updating task:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao atualizar task');
        }
    };
    ...
    const deleteTask = async (id)=>{
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('tasks').delete().eq('id', id);
            if (error) throw error;
            setTasks((prev)=>prev.filter((t)=>t.id !== id));
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Task deletada!');
        } catch (error) {
            console.error('Error deleting task:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao deletar task');
        }
    };
    // ========== TRANSACTIONS CRUD (Supabase - MIGRADO!) ==========
    const fetchTransactions = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').select(`
                    *,
                    clients (company_name)
                `).order('date', {
                ascending: false
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao carregar transações');
        } finally{
    ...
    const addTransaction = async (transactionData)=>{
        try {
            // Validate input
            const validation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateTransaction"])(transactionData);
            if (!validation.isValid) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validation$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatErrors"])(validation.errors));
                return;
            }
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').insert([
                {
            ...
            if (error) throw error;
            await fetchTransactions();
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Transação adicionada!');
        } catch (error) {
            console.error('Error adding transaction:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao adicionar transação');
        }
    };
    const updateTransaction = async (id, transactionData)=>{
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').update(transactionData).eq('id', id);
            if (error) throw error;
            await fetchTransactions();
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Transação atualizada!');
        } catch (error) {
            console.error('Error updating transaction:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao atualizar transação');
        }
    };
    const deleteTransaction = async (id)=>{
        try {
            ...
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('transactions').delete().eq('id', id);
            if (error) throw error;
            setTransactions((prev)=>prev.filter((t)=>t.id !== id));
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Transação deletada!');
        } catch (error) {
            console.error('Error deleting transaction:', error);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Erro ao deletar transação');
        }
    };
    // ========== INITIAL DATA LOAD ==========
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
...
_s(AppProvider, "60jW6xXUZlavFRuUcwlh1ZTWYe8=");
_c = AppProvider;
...
"[project]/lib/useNotifications.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useNotifications() {
    ...
    const { clients, tasks, transactions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
            ...
            if (stored) {
                try {
                    ...
                    const withDates = parsed.map({
                        "useNotifications.useEffect.withDates": (n)=>({
                                ...n,
                                timestamp: new Date(n.timestamp)
                            })
                    }["useNotifications.useEffect.withDates"]);
    ...
    const createNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[createNotification]": (type, title, message, priority = 'medium', actionUrl, actionLabel)=>{
            const icons = {
                deadline: '⏰',
                followup: '📞',
                financial: '💰',
            ...
            setNotifications({
                "useNotifications.useCallback[createNotification]": (prev)=>[
                        notification,
                        ...prev
                    ]
            }["useNotifications.useCallback[createNotification]"]);
            return notification;
        }
    }["useNotifications.useCallback[createNotification]"], []);
    // Check for deadlines - HARDENED
    const checkDeadlines = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[checkDeadlines]": ()=>{
            if (!tasks || tasks.length === 0) return;
            const now = new Date();
            tasks.forEach({
                "useNotifications.useCallback[checkDeadlines]": (task)=>{
                    try {
                        // Skip if no title
    ...
    const checkFollowups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[checkFollowups]": ()=>{
            if (!clients || clients.length === 0) return;
            const now = new Date();
            clients.forEach({
                "useNotifications.useCallback[checkFollowups]": (client)=>{
                    try {
                        ...
                        const alreadyNotified = notifications.some({
                            "useNotifications.useCallback[checkFollowups].alreadyNotified": (n)=>n.message?.includes(client.company_name || '') && n.type === 'followup' && !n.read
                        }["useNotifications.useCallback[checkFollowups].alreadyNotified"]);
                        if (alreadyNotified) return;
    ...
    const checkFinancials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[checkFinancials]": ()=>{
            ...
            try {
                ...
                const monthlyTransactions = transactions.filter({
                    "useNotifications.useCallback[checkFinancials].monthlyTransactions": (t)=>{
                ...
                }["useNotifications.useCallback[checkFinancials].monthlyTransactions"]);
                const revenue = monthlyTransactions.filter({
                    "useNotifications.useCallback[checkFinancials].revenue": (t)=>t.type === 'receita'
                }["useNotifications.useCallback[checkFinancials].revenue"]).reduce({
                    "useNotifications.useCallback[checkFinancials].revenue": (sum, t)=>sum + (t.amount || 0)
                }["useNotifications.useCallback[checkFinancials].revenue"], 0);
                const expenses = monthlyTransactions.filter({
                    "useNotifications.useCallback[checkFinancials].expenses": (t)=>t.type === 'despesa'
                }["useNotifications.useCallback[checkFinancials].expenses"]).reduce({
                    "useNotifications.useCallback[checkFinancials].expenses": (sum, t)=>sum + (t.amount || 0)
                }["useNotifications.useCallback[checkFinancials].expenses"], 0);
                const alreadyNotified = notifications.some({
                    "useNotifications.useCallback[checkFinancials].alreadyNotified": (n)=>n.type === 'financial' && n.message?.includes('despesas') && !n.read
                }["useNotifications.useCallback[checkFinancials].alreadyNotified"]);
    ...
    const checkRisks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[checkRisks]": ()=>{
            if (!clients || clients.length === 0) return;
            try {
                const inactiveClients = clients.filter({
                    "useNotifications.useCallback[checkRisks]": (c)=>c?.status === 'inativo'
                }["useNotifications.useCallback[checkRisks]"]).length;
                const alreadyNotified = notifications.some({
                    "useNotifications.useCallback[checkRisks].alreadyNotified": (n)=>n.type === 'risk' && n.message?.includes('inativos') && !n.read
                }["useNotifications.useCallback[checkRisks].alreadyNotified"]);
    ...
    // Run all checks - SAFE
    const runAllChecks = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[runAllChecks]": ()=>{
            try {
                checkDeadlines();
                checkFollowups();
                checkFinancials();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useNotifications.useEffect": ()=>{
            ...
            const interval = setInterval({
                "useNotifications.useEffect.interval": ()=>{
                    runAllChecks();
                }
            }["useNotifications.useEffect.interval"], 60000);
            return ({
    ...
    const deleteNotification = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useNotifications.useCallback[deleteNotification]": (id)=>{
            setNotifications({
...
_s(useNotifications, "LOyE956jvBuRSwOD/sphCCM3iww=", false, function() {
    return [
...
"[project]/lib/NotificationContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useNotifications$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/useNotifications.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
function NotificationProvider({ children }) {
    _s();
    const notificationData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useNotifications$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"])();
...
_s(NotificationProvider, "vFk+Ofwo1QM1vAH9rbw4Iy3RsI8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useNotifications$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotifications"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/NotificationContext.tsx [app-client] (ecmascript)");
...
function NotificationBell() {
    ...
    const { notifications, unreadCount, markAsRead, markAllAsRead, deleteNotification } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationContext"])();
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$bell$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Bell$3e$__["Bell"], {
                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("w-5 h-5", unreadCount > 0 && "animate-[ring_2s_ease-in-out_infinite]")
                    }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "jsx-9695918060db2655" + " " + ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("flex-1 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors", filter === 'all' ? "bg-violet-600 text-white" : "bg-slate-800 text-slate-400 hover:text-white") || ""),
                                        children: [
                                            "Todas (",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "jsx-9695918060db2655" + " " + ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("flex-1 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors", filter === 'unread' ? "bg-violet-600 text-white" : "bg-slate-800 text-slate-400 hover:text-white") || ""),
                                        children: [
                                            "Não lidas (",
                                            unreadCount,
                                            ")"
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: filteredNotifications.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: filteredNotifications.map((notification)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    className: "jsx-9695918060db2655" + " " + ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("p-3 rounded-lg border-l-3 transition-all group hover:bg-slate-800/50", !notification.read ? "bg-slate-900" : "bg-slate-950/50 opacity-70", getPriorityColor(notification.priority)) || ""),
...
_s(NotificationBell, "N25200aqrR2qa8QDujHKrSEwunw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useNotificationContext"]
    ];
});
_c = NotificationBell;
var _c;
...
function Sidebar({ isMobileOpen, onClose }) {
    ...
    const { profile, logout } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
    const handleLogout = ()=>{
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$NotificationBell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationBell"], {}, void 0, false, {
                                    fileName: "[project]/components/Sidebar.tsx",
                                    lineNumber: 69,
                                    columnNumber: 25
                                }, this)
...
_s(Sidebar, "MjmpGutgwKkpewxcr5qZlWFAt3k=", false, function() {
    return [
...
"[project]/lib/usePageContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "usePageContext.useMemo": ()=>{
            ...
            if (pathname === '/') {
                const activeClients = clients.filter({
                    "usePageContext.useMemo": (c)=>c.status === 'ativo'
                }["usePageContext.useMemo"]).length;
                const revenue = transactions.filter({
                    "usePageContext.useMemo.revenue": (t)=>t.type === 'receita'
                }["usePageContext.useMemo.revenue"]).reduce({
                    "usePageContext.useMemo.revenue": (sum, t)=>sum + t.amount
                }["usePageContext.useMemo.revenue"], 0);
                return {
                    page: 'dashboard',
                    title: 'Dashboard',
                    icon: '📊',
            ...
            if (pathname === '/clients') {
                const inactiveClients = clients.filter({
                    "usePageContext.useMemo": (c)=>c.status === 'inativo'
                }["usePageContext.useMemo"]).length;
                return {
                    page: 'clients',
                    title: 'Clientes',
            ...
            if (pathname === '/production') {
                const activeTasks = tasks.filter({
                    "usePageContext.useMemo.activeTasks": (t)=>t.stage !== 'concluido' && t.stage !== 'entregue'
                }["usePageContext.useMemo.activeTasks"]);
                return {
                    page: 'production',
                    title: 'Produção',
                    icon: '🎨',
            ...
            if (pathname === '/financial') {
                ...
                const expenses = transactions.filter({
                    "usePageContext.useMemo.expenses": (t)=>t.type === 'despesa'
                }["usePageContext.useMemo.expenses"]).reduce({
                    "usePageContext.useMemo.expenses": (sum, t)=>sum + t.amount
                }["usePageContext.useMemo.expenses"], 0);
                return {
                    page: 'financial',
                    title: 'Financeiro',
                    icon: '💰',
...
_s(usePageContext, "Y9ptKgsGgGUfImkrer1PDehfJfM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__User$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/user.js [app-client] (ecmascript) <export default as User>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/clsx/dist/clsx.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$usePageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/usePageContext.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AIAssistant() {
    ...
    // Get page context
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$usePageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePageContext"])();
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: [
                    ...
                    hasSuggestions && !isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            hasSuggestions && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    context.quickActions.length > 0 && messages.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: context.quickActions.map((action)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: messages.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                messages.map((msg, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("flex gap-3", msg.role === 'user' ? "flex-row-reverse" : "flex-row"),
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("w-8 h-8 rounded-full flex items-center justify-center shrink-0", msg.role === 'user' ? "bg-indigo-600" : "bg-slate-800"),
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("p-3 rounded-2xl max-w-[80%] text-sm whitespace-pre-wrap", msg.role === 'user' ? "bg-indigo-600 text-white rounded-tr-none" : "bg-slate-800 text-slate-200 rounded-tl-none border border-slate-700"),
...
_s(AIAssistant, "wvX9o1cTeMLjKSPQ5XCpzT56xlM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$usePageContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePageContext"]
    ];
});
_c = AIAssistant;
var _c;
...
"[project]/lib/useGlobalSearch.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useGlobalSearch() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGlobalSearch.useEffect": ()=>{
            const handleKeyDown = {
                "useGlobalSearch.useEffect.handleKeyDown": (e)=>{
                    // Open search
            ...
            }["useGlobalSearch.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "useGlobalSearch.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["useGlobalSearch.useEffect"];
        }
    }["useGlobalSearch.useEffect"], [
        isOpen
    ...
    const calculateScore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlobalSearch.useCallback[calculateScore]": (text, searchQuery)=>{
    ...
    }["useGlobalSearch.useCallback[calculateScore]"], []);
    // Search in all data
    const results = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlobalSearch.useMemo[results]": ()=>{
            if (!query.trim()) {
            ...
            // Search clients
            clients.forEach({
                "useGlobalSearch.useMemo[results]": (client)=>{
            ...
            // Search tasks
            tasks.forEach({
                "useGlobalSearch.useMemo[results]": (task)=>{
            ...
            transactions.forEach({
                "useGlobalSearch.useMemo[results]": (transaction)=>{
            ...
            return allResults.sort({
                "useGlobalSearch.useMemo[results]": (a, b)=>b.score - a.score
            }["useGlobalSearch.useMemo[results]"]).slice(0, 20); // Limit to 20 results
        }
    }["useGlobalSearch.useMemo[results]"], [
        query,
        clients,
    ...
    const groupedResults = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGlobalSearch.useMemo[groupedResults]": ()=>{
            const groups = {
                clients: [],
                tasks: [],
                transactions: [],
            ...
            results.forEach({
                "useGlobalSearch.useMemo[groupedResults]": (result)=>{
    ...
    const selectResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlobalSearch.useCallback[selectResult]": (result)=>{
            if (result.action) {
                result.action();
            } else if (result.url) {
    ...
    }["useGlobalSearch.useCallback[selectResult]"], [
        router
    ]);
    // Keyboard navigation
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGlobalSearch.useCallback[handleKeyDown]": (e)=>{
            if (!isOpen) return;
            if (e.key === 'ArrowDown') {
                e.preventDefault();
                setSelectedIndex({
                    "useGlobalSearch.useCallback[handleKeyDown]": (prev)=>Math.min(prev + 1, results.length - 1)
                }["useGlobalSearch.useCallback[handleKeyDown]"]);
            } else if (e.key === 'ArrowUp') {
                e.preventDefault();
                setSelectedIndex({
                    "useGlobalSearch.useCallback[handleKeyDown]": (prev)=>Math.max(prev - 1, 0)
                }["useGlobalSearch.useCallback[handleKeyDown]"]);
...
_s(useGlobalSearch, "5dBvRp5YHf7TcLgrt0et3cEMclM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"],
...
"[project]/components/GlobalSearch.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useGlobalSearch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/useGlobalSearch.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/clsx/dist/clsx.mjs [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
...
function GlobalSearch() {
    _s();
    const { isOpen, setIsOpen, query, setQuery, results, groupedResults, selectedIndex, selectResult } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useGlobalSearch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlobalSearch"])();
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: groupResults.map((result)=>{
                                                    ...
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-left transition-all", isSelected ? "bg-violet-600 text-white" : "hover:bg-slate-800 text-slate-300"),
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("text-sm font-medium truncate", isSelected ? "text-white" : "text-slate-200"),
                                                                    ...
                                                                    result.subtitle && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["clsx"])("text-xs truncate", isSelected ? "text-violet-200" : "text-slate-500"),
...
_s(GlobalSearch, "1TNgMEEOPgUR/k/E+29+UkZiA5g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useGlobalSearch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGlobalSearch"]
    ];
});
_c = GlobalSearch;
var _c;
...
"[project]/components/IOSInstallPrompt.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
        ...
        "IOSInstallPrompt.useEffect": ()=>{
            ...
            if (isIOS && !isStandalone && !wasDismissed) {
                ...
                const timer = setTimeout({
                    "IOSInstallPrompt.useEffect.timer": ()=>{
                        setShowPrompt(true);
                    }
                }["IOSInstallPrompt.useEffect.timer"], 2000);
                return ({
                    "IOSInstallPrompt.useEffect": ()=>clearTimeout(timer)
                })["IOSInstallPrompt.useEffect"];
            }
        }
    }["IOSInstallPrompt.useEffect"], []);
...
_s(IOSInstallPrompt, "tXUf3C7USH3Vjkn5dR0+vPdkmWY=");
_c = IOSInstallPrompt;
var _c;
__turbopack_context__.k.register(_c, "IOSInstallPrompt");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/notifications/push.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/components/PushNotificationPrompt.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$x$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__X$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/x.js [app-client] (ecmascript) <export default as X>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Check$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/check.js [app-client] (ecmascript) <export default as Check>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/notifications/push.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function PushNotificationPrompt() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PushNotificationPrompt.useEffect": ()=>{
            // Check support and permission on mount
            const supported = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isNotificationSupported"])();
            setIsSupported(supported);
            if (!supported) {
                return;
            }
            const currentPermission = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPermissionStatus"])();
            ...
            if (currentPermission === 'default' && !dismissed) {
                ...
                const timer = setTimeout({
                    "PushNotificationPrompt.useEffect.timer": ()=>{
                        setIsVisible(true);
                    }
                }["PushNotificationPrompt.useEffect.timer"], 3000);
                return ({
                    "PushNotificationPrompt.useEffect": ()=>clearTimeout(timer)
                })["PushNotificationPrompt.useEffect"];
            }
        }
    }["PushNotificationPrompt.useEffect"], []);
    const handleAllow = async ()=>{
        const granted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["requestNotificationPermission"])();
        if (granted) {
            setPermission('granted');
            // Subscribe to push
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToPush"])();
            // Send test notification
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendTestNotification"])();
            // Hide prompt
            setIsVisible(false);
        } else {
...
_s(PushNotificationPrompt, "ufshlz2hRv3aI9X29UUClaQN75E=");
_c = PushNotificationPrompt;
var _c;
__turbopack_context__.k.register(_c, "PushNotificationPrompt");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/lib/automations/conditions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/automations/actions.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/automations/conditions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/notifications/push.ts [app-client] (ecmascript)");
;
;
...
async function executeCreateTask(action, data, context) {
    ...
    const newTask = {
        id: Date.now(),
        title: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replaceVariables"])(title, data),
        description: description ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replaceVariables"])(description, data) : '',
...
async function executeNotify(action, data, context) {
    const message = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replaceVariables"])(action.message, data);
    const title = action.title ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["replaceVariables"])(action.title, data) : 'Automação';
    ...
    const canPush = ("TURBOPACK compile-time value", "object") !== 'undefined' && (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPermissionStatus"])() === 'granted';
    if (canPush) {
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$notifications$2f$push$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendLocalPushNotification"])(title, message, '/automations');
...
"[project]/lib/automations/engine.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/automations/conditions.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/automations/actions.ts [app-client] (ecmascript)");
;
;
async function runAutomation(automation, context) {
    ...
    try {
        ...
        for (const item of dataToCheck){
            // Evaluate conditions
            const conditionsMet = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$conditions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["evaluateConditions"])(automation.conditions, item, context);
            if (conditionsMet) {
                console.log(`✅ [Engine] Conditions met for:`, item);
                // Execute actions
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$actions$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["executeActions"])(automation.actions, item, context);
                if (result.success) {
                    actionsExecuted++;
                } else {
...
"[project]/lib/automations/predefined-rules.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/useAutomations.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/automations/engine.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$predefined$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/automations/predefined-rules.ts [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
;
...
function useAutomations() {
    _s();
    const [automations, setAutomations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [logs, setLogs] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [isRunning, setIsRunning] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Load automations from localStorage
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAutomations.useEffect": ()=>{
            if ("TURBOPACK compile-time falsy", 0) //TURBOPACK unreachable
            ;
             // Browser only
            const stored = localStorage.getItem(STORAGE_KEY);
            if (stored) {
                try {
                    const parsed = JSON.parse(stored);
                    setAutomations(parsed.map({
                        "useAutomations.useEffect": (a)=>({
                                ...a,
    ...
    const saveAutomations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[saveAutomations]": (newAutomations)=>{
            if ("TURBOPACK compile-time truthy", 1) {
                localStorage.setItem(STORAGE_KEY, JSON.stringify(newAutomations));
            }
            setAutomations(newAutomations);
        }
    }["useAutomations.useCallback[saveAutomations]"], []);
    // Create automation
    const createAutomation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[createAutomation]": (automation)=>{
            const newAutomation = {
                ...automation,
                id: Date.now().toString(),
                createdAt: new Date(),
    ...
    }["useAutomations.useCallback[createAutomation]"], [
        automations,
        saveAutomations
    ]);
    // Update automation
    const updateAutomation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[updateAutomation]": (id, updates)=>{
            const updated = automations.map({
                "useAutomations.useCallback[updateAutomation].updated": (a)=>a.id === id ? {
                        ...a,
                        ...updates,
                        updatedAt: new Date()
                    } : a
            }["useAutomations.useCallback[updateAutomation].updated"]);
            saveAutomations(updated);
        }
    }["useAutomations.useCallback[updateAutomation]"], [
        automations,
        saveAutomations
    ]);
    // Delete automation
    const deleteAutomation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[deleteAutomation]": (id)=>{
            saveAutomations(automations.filter({
                "useAutomations.useCallback[deleteAutomation]": (a)=>a.id !== id
            }["useAutomations.useCallback[deleteAutomation]"]));
        }
    }["useAutomations.useCallback[deleteAutomation]"], [
        automations,
        saveAutomations
    ...
    // Toggle automation
    const toggleAutomation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[toggleAutomation]": (id)=>{
            updateAutomation(id, {
                enabled: !automations.find({
                    "useAutomations.useCallback[toggleAutomation]": (a)=>a.id === id
                }["useAutomations.useCallback[toggleAutomation]"])?.enabled
            });
        }
    }["useAutomations.useCallback[toggleAutomation]"], [
        automations,
        updateAutomation
    ]);
    // Activate predefined rule
    const activatePredefined = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[activatePredefined]": (templateName)=>{
            const automation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$predefined$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createFromTemplate"])(templateName);
    ...
    }["useAutomations.useCallback[activatePredefined]"], [
        automations,
        saveAutomations
    ]);
    // Run automations
    const runAutomationsNow = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[runAutomationsNow]": async (context)=>{
            setIsRunning(true);
            try {
                const newLogs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$engine$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["runAllAutomations"])(automations, context);
                // Update lastRun and runCount
                const updated = automations.map({
                    "useAutomations.useCallback[runAutomationsNow].updated": (a)=>{
                        const log = newLogs.find({
                            "useAutomations.useCallback[runAutomationsNow].updated.log": (l)=>l.automationId === a.id
                        }["useAutomations.useCallback[runAutomationsNow].updated.log"]);
                        if (log) {
                            return {
                                ...a,
                ...
                }["useAutomations.useCallback[runAutomationsNow].updated"]);
                saveAutomations(updated);
                setLogs([
                    ...newLogs,
                    ...logs
    ...
    }["useAutomations.useCallback[runAutomationsNow]"], [
        automations,
        logs,
        saveAutomations
    ]);
    // Get predefined templates
    const getPredefinedRules = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[getPredefinedRules]": ()=>{
            return __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$automations$2f$predefined$2d$rules$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PREDEFINED_AUTOMATIONS"];
        }
    }["useAutomations.useCallback[getPredefinedRules]"], []);
    // Get active automations
    const getActiveAutomations = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAutomations.useCallback[getActiveAutomations]": ()=>{
            return automations.filter({
                "useAutomations.useCallback[getActiveAutomations]": (a)=>a.enabled
            }["useAutomations.useCallback[getActiveAutomations]"]);
        }
    }["useAutomations.useCallback[getActiveAutomations]"], [
        automations
...
_s(useAutomations, "oq2afAOHmKFmgnESO91hGZWvGPI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/AutomationScheduler.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useAutomations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/useAutomations.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/store.tsx [app-client] (ecmascript)");
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AutomationScheduler() {
    _s();
    const { getActiveAutomations, runAutomationsNow } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useAutomations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutomations"])();
    const { clients, tasks, transactions } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AutomationScheduler.useEffect": ()=>{
            console.log('🤖 [Scheduler] Starting automation scheduler...');
            // Run automations every 5 minutes
            const interval = setInterval({
                "AutomationScheduler.useEffect.interval": async ()=>{
            ...
            }["AutomationScheduler.useEffect.interval"], 5 * 60 * 1000); // 5 minutes
            // Cleanup
            return ({
                "AutomationScheduler.useEffect": ()=>{
...
_s(AutomationScheduler, "rONCq7m/Ensj9bc8STpM5IfVcRM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$useAutomations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAutomations"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
_c = AutomationScheduler;
var _c;
__turbopack_context__.k.register(_c, "AutomationScheduler");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "space-y-3",
                    children: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COLLABORATORS"].map((collab)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            type: "button",
...
_s(LoginPage, "zi7LZWOY2WEnYqzmKSlPZEb7ynU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$GlobalSearch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/GlobalSearch.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$IOSInstallPrompt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/IOSInstallPrompt.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PushNotificationPrompt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/PushNotificationPrompt.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AutomationScheduler$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/AutomationScheduler.tsx [app-client] (ecmascript)");
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AuthProvider"], {
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AppProvider"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$NotificationContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["NotificationProvider"], {
...
function LayoutContent({ children }) {
        ...
        "LayoutContent.useEffect": ()=>{
            if ('serviceWorker' in navigator) {
                navigator.serviceWorker.register('/sw.js').then({
                    "LayoutContent.useEffect": (registration)=>{
                        console.log('✅ Service Worker registered:', registration.scope);
                    }
                }["LayoutContent.useEffect"]).catch({
                    "LayoutContent.useEffect": (error)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AIAssistant$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AIAssistant"], {}, void 0, false, {
                fileName: "[project]/app/layout.tsx",
                lineNumber: 97,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$GlobalSearch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GlobalSearch"], {}, void 0, false, {
                fileName: "[project]/app/layout.tsx",
                lineNumber: 98,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$IOSInstallPrompt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IOSInstallPrompt"], {}, void 0, false, {
                fileName: "[project]/app/layout.tsx",
                lineNumber: 99,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$PushNotificationPrompt$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PushNotificationPrompt"], {}, void 0, false, {
                fileName: "[project]/app/layout.tsx",
                lineNumber: 100,
                columnNumber: 13
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AutomationScheduler$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AutomationScheduler"], {}, void 0, false, {
                fileName: "[project]/app/layout.tsx",
                lineNumber: 101,
                columnNumber: 13
            }, this)
...
_s(LayoutContent, "cLnWtkDZIxcyLYgBVXDYf3vokCM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7c57a2d8._.js.map